...
class TimeManagerHomePage extends StatefulWidget {
  const TimeManagerHomePage({Key key, @required this.database, this.job})
      : super(key: key);
  ...
  static Future<void> show(
    ...
    await Navigator.of(context, rootNavigator: true).push(
      MaterialPageRoute(
        builder: (context) => TimeManagerHomePage(
          database: database,
          job: job,
        ),
  ...
  @override
  _TimeManagerHomePageState createState() => _TimeManagerHomePageState();
}

class _TimeManagerHomePageState extends State<TimeManagerHomePage> {
  @override
